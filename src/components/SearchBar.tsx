    ...
    <div data-no-drag-select className="mt-6 mb-4 flex gap-3">
      <div className="flex gap-2 flex-shrink-0 z-20">
        <button
          ...
          title={filterFavorite ? t('search.cancelOnlyFavorites') : t('search.onlyFavorites')}
        >
        ...
        <div className="relative w-28">
          <Select
            ...
            options={[
              { label: t('search.allStatus'), value: 'all' },
              { label: t('search.done'), value: 'done' },
              { label: t('search.running'), value: 'running' },
              { label: t('search.error'), value: 'error' },
            ]}
